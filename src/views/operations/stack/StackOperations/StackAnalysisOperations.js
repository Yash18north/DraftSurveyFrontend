...
import { sampleMarkOptionsLotWiseApi } from "../../../../services/api";
...
import { getActivityCode, getLMSActivityHeaderTab, getSampleCollectionActivity, getStackOperations } from "../../../../services/commonFunction";
...
const StackAnalysisOperations = () => {
  ...
  if ([getStackOperations('PV'), getStackOperations('')].includes(operationType)) {
...
export default StackAnalysisOperations;
