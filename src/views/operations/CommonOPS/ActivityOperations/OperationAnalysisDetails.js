...
import { getActivityCode, getLMSActivityHeaderTab, getLMSOperationActivity, getOperationActivityListPageUrl, getOperationNameByCode, getSampleCollectionActivity, getVesselOperation } from "../../../../services/commonFunction"
...
const OperationAnalysisDetails = () => {
  ...
  formConfig['breadcom'][0]['title'] = getOperationNameByCode(operationMode) + " List"
  formConfig['breadcom'][0]['redirect'] = getOperationActivityListPageUrl(operationMode)
...
export default OperationAnalysisDetails;
