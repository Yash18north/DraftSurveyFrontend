...
import OnlySeal_formConfig from "../../../../formJsonData/Operations/Truck/OtherOperations/OnlySealOperation.json";
import CargoSupervision_formConfig from "../../../../formJsonData/Operations/Truck/OtherOperations/CargoSuperVisionOperation.json";
...
const OtherOperations = () => {
  ...
  useEffect(() => {
    ...
    else if (TMLType == getOtherOperations("CS")) {
