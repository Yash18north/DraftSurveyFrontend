...
//     const pad = (n) => (n < 10 ? `0${n}` : n); // Helper for zero-padding
...
//     // Validate input format using regex for 'yyyy-MM-dd HH:mm'
...
//     setErrorMsg(false); // Hide error message if valid

//     // Parse input value to a valid date
...
//         target: {
//           name,
//           value: formatDateToString(parsedDate), // Send formatted value
//         },
//       });
//     }
//   };
...
//               (readOnly ? "labelInput" : "") +
//               (errorMsg ? " border-danger" : "") // Add red border if invalid
//             }
//             readOnly={readOnly}
//             customInput={
//               <input
...
//                   padding: "8px",
//                   fontSize: "14px",
//                   border: errorMsg ? "1px solid red" : "1px solid #ccc", // Add red border if invalid
//                   borderRadius: "4px",
//                 }}
//               />
//             }
...
//               Please enter a valid date and time (yyyy-MM-dd HH:mm).
//             </p>
//           )}
//         </div>
