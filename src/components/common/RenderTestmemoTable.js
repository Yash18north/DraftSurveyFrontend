        ...
        <CardBody>
          ...
          <div className="test_memo_selections">
            <div className="form-group my-2">
              <label htmlFor="Sample Id List" style={{ width: `${25}%` }}>Sample Id List</label>
              <div
                className={
                  "w-" + "50" + " d-inline-block mx-2 sample_code_list"
                }
              >
            ...
            <div className="form-group my-2">
              <label htmlFor="group" style={{ width: `${25}%` }}>Group </label>
              <div
                className={
                  "w-" + "50" + " d-inline-block mx-2 sample_code_list"
                }
