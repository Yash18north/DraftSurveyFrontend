...
export const handleJICreateOrUpdate = async (
  ...
  let payloadData = {
    ...
    fk_commodityid: typeof formData[0].fk_commodityid === 'object' ? formData[0].fk_commodityid.cmd_id : formData[0].fk_commodityid,
    fk_subcommodityid: typeof formData[0].fk_subcommodityid === 'object' ? formData[0].fk_subcommodityid.sub_cmd_id : formData[0].fk_subcommodityid,
